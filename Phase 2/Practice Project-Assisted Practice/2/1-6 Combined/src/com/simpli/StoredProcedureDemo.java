...
@WebServlet("/stored-procedure-statement-demo")
public class StoredProcedureDemo extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		PrintWriter out = response.getWriter();
		// Demo inserting new row using Callable statement
		// callable statement will call the stored procedure
		try {
			...
			callableStmt.setString(2, price);
